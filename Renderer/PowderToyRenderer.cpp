...
{	
	...
	ptiFilename = outputPrefix+"_large.pti";
	ptiSmallFilename = outputPrefix+"_small.pti";
	pngFilename = outputPrefix+"_large.png";
	pngSmallFilename = outputPrefix+"_small.png";
